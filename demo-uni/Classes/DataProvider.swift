...
//        if let url = URL(string: "https://api.ari.arq.su/model/174533c2-3cea-4a61-8b29-b85a8f7d605b")
        //        if let url = URL(string: "https://api.ari.arq.su/model/scn_test")
//        if let url = URL(string: "https://api.ari.arq.su/model/fbx_test")
          if let url = URL(string: "https://api.ari.arq.su/model/dodge_test")
        {
