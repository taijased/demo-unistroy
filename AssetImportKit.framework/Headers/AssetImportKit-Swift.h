...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AssetImportKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14AssetImportKit22AssetImporterAnimation")
@interface AssetImporterAnimation : SCNScene
...
SWIFT_CLASS("_TtC14AssetImportKit18AssetImporterScene")
@interface AssetImporterScene : SCNScene
